...
const imgList = [
  ...
  },
  {
    ...
    caption: "A couple tasting their dinner and some random bleh bleh",
    id: 1
  },
  {
    src:
    ...
    caption: "A random beach from bali",
    id: 2
  },
  {
    src:
    ...
    caption:
      "An image having a bike in the foreground and a grafitti in the background",
    id: 3
  },
  {
    src:
    ...
    caption: "some random dashboard photo bleh bleh",
    id: 4
  }
];

// controller.addDataToListPane(imgList);
const controller = new Controller(imgList);
